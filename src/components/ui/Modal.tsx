...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative w-full ${width} card animate-pop max-h-[90vh] flex flex-col`}>
        ...
        {footer && <div className="px-5 py-4 border-t border-[#eef2f8] flex justify-end gap-2">{footer}</div>}
      </div>
    </div>
  )
}
